...
python train_nas.py --data coco_subset.yaml --cfg models/nas/yolov5s.supernet.one_branch_bin.yaml --batch-size 32 --device 1 --epochs 300 --name exp_nas_bin --split 
