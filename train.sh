...
python train_nas.py --data coco_subset.yaml --cfg models/nas/yolov5s.supernet.one_branch_vae_bin.yaml --batch-size 32 --device 1 --epochs 300 --name exp_nas_vae_bin --split 
# --resume --weights ./runs/train/exp_nas_vae_bin2/weights/last.pt


# train single branch NAS with VAENorm
# python train_nas.py --data coco.yaml --cfg models/nas/yolov5s.supernet.one_branch.yaml --batch-size 32 --device 1 --epochs 400 --name exp_nas_vaenorm --split 
